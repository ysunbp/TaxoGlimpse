                    ...
                    for variant_id in args.variant_ids:
                        ...
                        for cur_inps_key in inps_dict.keys():
                            ...
                            if variant_id == 0:
                                ...
                                cur_path = 'TaxoGlimpse/results/zero-shot-'+str(variant_id)+'/'+cur_taxonomy+'/'+args.model_path.split('/')[1]+'/'+cur_question_cat+'.csv'
                            yes_total = 0
                            no_total = 0
                            dont_total = 0
...
if __name__ == "__main__":
    ...
    main(args)
    ### command: python3 -m fastchat.serve.tf-variants --model-path lmsys/vicuna-33b-v1.3 >> TaxoGlimpse/logs/vicuna-33b/log.txt
