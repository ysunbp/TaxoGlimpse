            ...
            for cur_taxonomy in args.question_path:
                ...
                for cur_sampled_question_pairs in cur_question_pairs:
                    ...
                    for cur_inps_key in inps_dict.keys():
                        ...
                        cur_path = 'TaxoGlimpse/results/instance-full-zero/'+cur_taxonomy+'/'+args.model_path.split('/')[1]+'/'+cur_question_cat+'.csv'
                        yes_total = 0
                        no_total = 0
                        dont_total = 0
...
if __name__ == "__main__":
    ...
    main(args)
    ### command: python3 -m fastchat.serve.cli-zero-shot-instance-full --model-path lmsys/vicuna-7b-v1.5 >> /export/data/LLM-benchmark-project-KB/logs/vicuna-7b/instance-full-zero-shot.txt
    ### command: python3 -m fastchat.serve.cli-zero-shot-instance-full --model-path lmsys/vicuna-13b-v1.5 >> /export/data/LLM-benchmark-project-KB/logs/vicuna-13b/instance-full-zero-shot.txt
    ### command: python3 -m fastchat.serve.cli-zero-shot-instance-full --model-path lmsys/vicuna-33b-v1.3 >> /export/data/LLM-benchmark-project-KB/logs/vicuna-33b/instance-full-zero-shot.txt