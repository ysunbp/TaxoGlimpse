...
def generateResponse(prompt, gpt_name, exp_type):
    ...
    if exp_type == 'instance-full-zero':
    ...
    elif exp_type == 'instance-full-COT':
...
def compose_questions_get_response_ctd(sampled_question_pairs, taxonomy_type, ckpt_dir, exp_type='zero-shot'):
    if exp_type == 'instance-full-zero':
        ...
        for sampled_question_key in sampled_question_pairs.keys():
            ...
            print('++++++++++++++++++++++++++++++++++++++++')
    elif exp_type == 'instance-full-few': #TODO: modify the question composing part
...
if __name__ == "__main__":
    ...
    exp_types = ['instance-full-zero', 'instance-full-few', 'instance-full-COT']
    #exp_types = ['instance-full-zero']

    for exp_type in exp_types:
        #exp_type = 'instance-full-zero'
