...
if __name__ == "__main__":
    ...
    model = AutoModelForSeq2SeqLM.from_pretrained("google/flan-t5-xxl", device_map="auto") # 11B
    ...
    for question_pool_name in question_pool_names:
        for variant_id in variant_ids:
            ...
            for cur_question_pair in cur_question_pairs:
                compose_questions_get_response(cur_question_pair, taxonomy_type=question_pool_name, model=model, tokenizer=tokenizer, model_name='flan-t5-11b', variant_id=variant_id)
