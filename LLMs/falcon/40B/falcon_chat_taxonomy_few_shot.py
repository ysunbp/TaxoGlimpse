            ...
            for idx, (roottype_o, subtype_o) in enumerate(tqdm(cur_sampled_question_pairs[sampled_question_key])):
                ...
                if taxonomy_type == 'academic-acm':
                    ...
                    for message in messages:
                        dialog += message[0]
                        dialog += message[1]
                    last_sent = 'Is ' + subtype_o + ' computer science research concept a type of '+roottype_o +' computer science research concept? answer with (Yes/No/I don\'t know)' + '\nAnswer:'
                    dialog = dialog+last_sent
                    ...
                    for message in messages:
                        dialog += message[0]
                        dialog += message[1]
                    last_sent = 'Is ' + subtype_o + ' a type of '+roottype_o +'? answer with (Yes/No/I don\'t know)' + '\nAnswer:'
                    dialog = dialog+last_sent
                    ...
                    for message in messages:
                        dialog += message[0]
                        dialog += message[1]
                    last_sent = 'Is ' + subtype_o + ' language a type of '+roottype_o +' language? answer with (Yes/No/I don\'t know)' + '\nAnswer:'
                    dialog = dialog+last_sent
                    ...
                    for message in messages:
                        dialog += message[0]
                        dialog += message[1]
                    last_sent = 'Is ' + subtype_o.lower() + ' a type of '+roottype_o.lower() +'? answer with (Yes/No/I don\'t know)' + '\nAnswer:'
                    dialog = dialog+last_sent
                    ...
                    for message in messages:
                        dialog += message[0]
                        dialog += message[1]
                    last_sent = 'Are ' + subtype_o + ' products a type of '+roottype_o +' products? answer with (Yes/No/I don\'t know)' + '\nAnswer:'
                    dialog = dialog+last_sent
                ...
                falcon_answer = sequences[0]['generated_text'].split(last_sent)[-1].lower().split('is')[0].split('are')[0].strip()
                ...
                if 'yes' in falcon_answer:
                    ...
                    decision = 0
                    no_total += 1
                cur_row = (roottype_o, subtype_o, falcon_answer, decision)
