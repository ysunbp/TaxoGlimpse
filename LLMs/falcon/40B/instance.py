...
def get_sampled_pairs(sub_question_type='level', level_question_types=['positive'], toroot_question_types=None, question_pool_name = 'academic-acm'):
    ...
    if not question_pool_name in ['academic-acm', 'biology-NCBI', 'medical-icd', 'shopping-amazon']:
    ...
    for question_pool_name in question_pool_names:
        for variant_id in variant_ids:
            ...
            for cur_question_pair in cur_question_pairs:
                compose_questions_get_response(cur_question_pair, taxonomy_type=question_pool_name, pipeline=pipeline, tokenizer=tokenizer, model_name='falcon-40b', variant_id=variant_id)
